...
export default function ITRentalsPage() {
  ...
  const [meta, setMeta]             = useState<{companies:any[];gaCompanies:any[];vendors:any[];helpdeskUsers:any[];helpdeskCompanies:any[]}>({companies:[],gaCompanies:[],vendors:[],helpdeskUsers:[],helpdeskCompanies:[]});
